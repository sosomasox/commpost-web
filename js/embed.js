(async function() {
    var url = 'https://commpost-api.c1.hacobuneapp.com/api/v1/healthz';
    var method = 'GET';
...
function getComment(article_id) {
    var url = 'https://commpost-api.c1.hacobuneapp.com/api/v1/comments?article_id=' + article_id;
    var method = 'GET';
...
async function sendComment() {
    ...
    var url = 'https://commpost-api.c1.hacobuneapp.com/api/v1/comments';
    var obj = {
