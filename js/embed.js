(async function() {
    var url = 'https://commpost.sosomasox.com/api/v1/healthz';
    var method = 'GET';
    ...
    timeout(3000, fetch(url, {
        ...
        if (json['status'] == "ok") {
            ...
            promise.then(function(json) {
                ...
                logo_img.setAttribute('src', 'https://commpost.sosomasox.com/assets/img/logo.png');
                ...
                commpost_comment_post_loading_img.setAttribute('src', 'https://commpost.sosomasox.com/assets/gif/logo.gif');
...
function getComment(article_id) {
    var url = 'https://commpost.sosomasox.com/api/v1/comments?article_id=' + article_id;
    var method = 'GET';
...
async function sendComment() {
    ...
    var url = 'https://commpost.sosomasox.com/api/v1/comments';
    var obj = {
